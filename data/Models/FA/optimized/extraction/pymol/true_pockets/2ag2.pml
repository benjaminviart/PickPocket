load ../../../PDB/pdb2ag2.ent
# ligand_0
select ligand_0, chain B and resi 3628 
...
# ligand_1
select ligand_1, chain B and resi 3046 
...
# ligand_2
select ligand_2, chain B and resi 1364 
...
# ligand_3
select ligand_3, chain C and resi 3629 
...
# ligand_4
select ligand_4, chain C and resi 3045 
...
select true_pocket_0, chain B and resi 19+39+118+37+116+105+41+155+24+40+157+117
...
select true_pocket_1, chain B and resi 79+73+55+89+141
...
select true_pocket_2, chain B and resi 128+123+126+35+125+29+74
...
select true_pocket_3, chain C and resi 117+39+159+141+41+37+157+118+19+24+116
...
select true_pocket_4, chain C and resi 125+123
